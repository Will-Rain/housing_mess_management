...
layui.define(["okUtils"], function (exprots) {
	...
	var okHoliday = {
		getContent: function() {
			...
			let content = "";
			if (dateStr == "2021-01-01") {
			  content = "元旦，一年之始也。元，初，始也；旦，太阳微露地平一线，是为一日之始。值此新年之际，祝诸君快乐安康，如意吉祥！<br/>" +
			    "ok-admin v2.0 祝您元旦节快乐！(^し^)";
			} else if (dateStr == "2021-01-24" || dateStr == "2021-01-25" || dateStr == "2021-01-26" || dateStr == "2021-01-27" || dateStr == "2021-01-28" || dateStr == "2021-01-29" || dateStr == "2021-01-30") {
