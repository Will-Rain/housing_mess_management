		...
		getContent: function() {
			...
			if (dateStr == "2021-01-01") {
			  ...
			  content = "鞭炮声声迎新年，妙联横生贴门前。<br/>" +
			    ...
			    "稚童新衣相夸耀，旧去新来气象清。<br/>" +
			    "祝您春节快乐！(^し^)";
			} else if (dateStr == "2021-04-04" || dateStr == "2021-04-05" || dateStr == "2021-04-06") {
			  content = "清明时节雨纷纷，路上行人欲断魂。<br/>" +
			    "借问酒家何处有，牧童遥指杏花村。<br/>" +
			    "祝您清明节快乐！(^し^)";
			} else if (dateStr == "2021-05-01" || dateStr == "2021-05-02" || dateStr == "2021-05-03" || dateStr == "2020-05-04" || dateStr == "2020-05-05") {
